 ...
 * 定义击杀特定怪物可获得的经验值
 */
public class AdventureExpSource {
    private final ResourceLocation entityType;
    private final int baseExp;
    private final List<String> tags; // 可选的实体标签匹配

    public AdventureExpSource(ResourceLocation entityType, int baseExp, List<String> tags) {
    ...
    public static AdventureExpSource fromJson(JsonObject json) {
        ...
        return new AdventureExpSource(entityType, baseExp, tags);
    }
}
