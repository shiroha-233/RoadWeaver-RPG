...
public class QuestBoardScreen extends Screen {
    ...
    private void renderQuestCard(GuiGraphics graphics, int x, int y, int width, int height,
        ...
        GuiRenderer.drawQuestCard(graphics, x, y, width, height, quest.getRank().getScrollColor(), hovered, selected);
        ...
        int textColor = hovered ? 0xFF3D2817 : 0xFF5C4033;
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (button == 0 && hoveredQuest != null) {
            ...
            // 使用卷轴样式的预览界面
            if (minecraft != null) {
                minecraft.setScreen(new QuestPreviewScreen(this, hoveredQuest, acceptHandler));
            }
            return true;
        }
