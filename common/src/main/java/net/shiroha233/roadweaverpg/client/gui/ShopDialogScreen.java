...
import net.shiroha233.roadweaverpg.network.packet.ShopDialogResponsePacket;
...
public class ShopDialogScreen extends Screen {
    ...
    private static List<ShopDialogOption> createDefaultOptions() {
        ...
        options.add(new ShopDialogOption(
                Component.translatable("gui.roadweaver_rpg.shop_dialog.who_are_you"),
                ShopDialogResponsePacket.ShopDialogOption.WHO_ARE_YOU,
                false
        ));
        options.add(new ShopDialogOption(
