...
public class DialogOption {
    ...
    public static final String KEY_WHO_ARE_YOU = "gui.roadweaver_rpg.dialog.who_are_you";
     ...
     * 创建标准对话选项
     */
    public static DialogOption whoAreYou() {
        return new DialogOption(
                Component.translatable(KEY_WHO_ARE_YOU),
                DialogResponsePacket.DialogOption.WHO_ARE_YOU
        );
    }
    ...
    public static DialogOption cancel() {
        return new DialogOption(
                ...
                DialogResponsePacket.DialogOption.WHO_ARE_YOU,  // 占位，实际会关闭界面
                true
        );
    }
}
