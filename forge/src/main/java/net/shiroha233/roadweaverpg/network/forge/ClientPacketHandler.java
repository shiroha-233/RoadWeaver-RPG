...
public class ClientPacketHandler {
    ...
    public static void handleSyncQuestInstance(SyncQuestInstancePacket packet) {
        ...
        // 通知委托书处理器（用于延迟打开）
        net.shiroha233.roadweaverpg.client.forge.QuestScrollClientHandler.onInstanceSynced(packet.instance());
    }
     ...
     * 处理RPG属性同步
     */
    public static void handleSyncRpgStats(
            net.shiroha233.roadweaverpg.network.forge.message.SyncRpgStatsMessage packet) {
        net.shiroha233.roadweaverpg.client.ClientStatsCache.updateFromServer(
