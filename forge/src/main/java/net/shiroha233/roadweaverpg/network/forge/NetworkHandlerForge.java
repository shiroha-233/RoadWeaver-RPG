package net.shiroha233.roadweaverpg.network.forge;
...
public class NetworkHandlerForge {
    ...
    public static void registerProfessionPackets() {
        // 服务端 -> 客户端：同步职业定义
        CHANNEL.registerMessage(packetId++,
                net.shiroha233.roadweaverpg.network.forge.message.SyncProfessionsMessage.class,
                net.shiroha233.roadweaverpg.network.forge.message.SyncProfessionsMessage::encode,
                net.shiroha233.roadweaverpg.network.forge.message.SyncProfessionsMessage::decode,
                net.shiroha233.roadweaverpg.network.forge.message.SyncProfessionsMessage::handle,
                Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        
        // 服务端 -> 客户端：同步玩家职业
        CHANNEL.registerMessage(packetId++,
                net.shiroha233.roadweaverpg.network.forge.message.SyncPlayerProfessionMessage.class,
                net.shiroha233.roadweaverpg.network.forge.message.SyncPlayerProfessionMessage::encode,
                net.shiroha233.roadweaverpg.network.forge.message.SyncPlayerProfessionMessage::decode,
                net.shiroha233.roadweaverpg.network.forge.message.SyncPlayerProfessionMessage::handle,
                Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        
        // 服务端 -> 客户端：打开职业选择界面
        CHANNEL.registerMessage(packetId++,
                net.shiroha233.roadweaverpg.network.forge.message.OpenProfessionSelectionMessage.class,
                net.shiroha233.roadweaverpg.network.forge.message.OpenProfessionSelectionMessage::encode,
                net.shiroha233.roadweaverpg.network.forge.message.OpenProfessionSelectionMessage::decode,
                net.shiroha233.roadweaverpg.network.forge.message.OpenProfessionSelectionMessage::handle,
                Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        
        // 客户端 -> 服务端：选择职业
        CHANNEL.registerMessage(packetId++,
                net.shiroha233.roadweaverpg.network.forge.message.SelectProfessionMessage.class,
                net.shiroha233.roadweaverpg.network.forge.message.SelectProfessionMessage::encode,
                net.shiroha233.roadweaverpg.network.forge.message.SelectProfessionMessage::decode,
                net.shiroha233.roadweaverpg.network.forge.message.SelectProfessionMessage::handle,
                Optional.of(NetworkDirection.PLAY_TO_SERVER));
        
        // 客户端 -> 服务端：转职
        CHANNEL.registerMessage(packetId++,
                net.shiroha233.roadweaverpg.network.forge.message.ChangeProfessionMessage.class,
                net.shiroha233.roadweaverpg.network.forge.message.ChangeProfessionMessage::encode,
                net.shiroha233.roadweaverpg.network.forge.message.ChangeProfessionMessage::decode,
                net.shiroha233.roadweaverpg.network.forge.message.ChangeProfessionMessage::handle,
                Optional.of(NetworkDirection.PLAY_TO_SERVER));
        ...
        // 服务端 -> 客户端：同步RPG属性
        CHANNEL.registerMessage(packetId++,
                net.shiroha233.roadweaverpg.network.forge.message.SyncRpgStatsMessage.class,
                net.shiroha233.roadweaverpg.network.forge.message.SyncRpgStatsMessage::encode,
                net.shiroha233.roadweaverpg.network.forge.message.SyncRpgStatsMessage::decode,
                (packet, ctx) -> {
                    ctx.get().enqueueWork(() -> ClientPacketHandler.handleSyncRpgStats(packet));
                    ctx.get().setPacketHandled(true);
                }, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        
        // 初始化RPG属性同步回调
        net.shiroha233.roadweaverpg.stats.RpgStatsService.setSyncCallback(
                data -> sendRpgStats(data.player(), data));
    }
    
    /**
     * 发送RPG属性到客户端
     */
    public static void sendRpgStats(ServerPlayer player, 
            net.shiroha233.roadweaverpg.stats.RpgStatsService.RpgStatsSyncData data) {
        net.shiroha233.roadweaverpg.network.forge.message.SyncRpgStatsMessage.send(
                player, data.attack(), data.maxMana(), data.magicAttack(), data.critRate(), data.critDamage(),
                data.hitRate(), data.dodgeRate(), data.healthRegen(), data.manaRegen(),
                data.lifeSteal(), data.manaSteal(), data.cooldownReduction(),
                data.expBonus(), data.dropBonus());
    }
    ...
    public static void sendPlayerProfession(ServerPlayer player, ResourceLocation professionId) {
        net.shiroha233.roadweaverpg.network.forge.message.SyncPlayerProfessionMessage.send(player, professionId);
    }
    ...
    public static void sendProfessionDefinitions(ServerPlayer player, 
        ...
        CHANNEL.send(PacketDistributor.PLAYER.with(() -> player),
                new net.shiroha233.roadweaverpg.network.forge.message.SyncProfessionsMessage(definitions));
    }
    ...
    public static void sendOpenProfessionSelection(ServerPlayer player, int npcEntityId) {
        CHANNEL.send(PacketDistributor.PLAYER.with(() -> player),
                new net.shiroha233.roadweaverpg.network.forge.message.OpenProfessionSelectionMessage(npcEntityId));
    }
